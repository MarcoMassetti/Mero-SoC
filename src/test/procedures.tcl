...
proc report_rf {} {
	set output_file "$::env(OBJ_DIR)/$::env(SOURCE_FILE_NAME)_rf_dut.txt"
	set rf_path "sim:/cpu_top_tb/DUT/inst_cpu/inst_register_file/registers"
...
proc compare_rf_content {} {
	if {[catch {exec diff $::env(OBJ_DIR)/$::env(SOURCE_FILE_NAME)_rf_dut.txt $::env(OBJ_DIR)/$::env(SOURCE_FILE_NAME)_rf_golden.txt} fid]} {
