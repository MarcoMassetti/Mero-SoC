...
create_project chip_top_ddr ./runs/chip_top_ddr -part xc7s25csga324-1
set_property board_part digilentinc.com:arty-s7-25:part0:1.1 [current_project]

# Add verilog defines used in rtl
set_property verilog_define {FPGA DDR} [current_fileset]

# Add constraint file
add_files -fileset constrs_1 -norecurse ./sources/Arty-S7-25.xdc

# Add design files
add_files -norecurse {../src/design/cpu/cpu_interface_ctrl.v ../src/design/uart_ctrl/uart_ctrl.v ../src/design/cpu/byte_operation_unit.v ../src/design/uart_ctrl/axi_uart_ctrl.v ../src/design/axi_blocks/axi_interconnect.v ../src/design/spi_ctrl/axi_spi_mst.v ../src/design/axi_blocks/axi_ram_wrapper.v ../src/design/spi_ctrl/spi_boot_ctrl.v ../src/design/axi_blocks/axi_2_hs.v ../src/design/spi_ctrl/spi_mst.v ../src/design/axi_blocks/hs_2_axi.v ../src/design/cpu/register_file.v ../src/design/axi_blocks/axi_cdc.v ../src/design/cpu/control_unit.v ../src/design/cpu/alu.v ../src/design/cpu/cpu.v ../src/design/fifos/sync_fifo.v ../src/design/ram_macro/sky130_sram_2kbyte_1rw_32x512_8.v ../src/design/cpu/alu_control_unit.v ../src/design/cpu/axi_cpu_interface_ctrl.v ../src/design/fifos/async_fifo.v ../src/design/chip_top.v}
...
# Add IPs files
import_ip {./sources/clk_wiz_0.xci ./sources/mig_7series_0.xci}
reset_target all [get_files ./runs/chip_top_ddr/chip_top_ddr.srcs/sources_1/ip/mig_7series_0/mig_7series_0.xci]
set_property CONFIG.XML_INPUT_FILE ../../../../../../sources/mig_7series_0.prj [get_ips mig_7series_0]

# Generate IPs
generate_target all [get_files ./runs/chip_top_ddr/chip_top_ddr.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci]
generate_target all [get_files ./runs/chip_top_ddr/chip_top_ddr.srcs/sources_1/ip/mig_7series_0/mig_7series_0.xci]
...
write_cfgmem  -format bin -size 2 -interface SPIx4 -loadbit {up 0x00000000 "./runs/chip_top_ddr/chip_top_ddr.runs/impl_1/chip_top.bit" } -loaddata {up 0x00130000 "./sources/software.bin" } -force -file "./runs/chip_top_ddr/chip_top_ddr.runs/impl_1/chip_top_ddr.bin"
